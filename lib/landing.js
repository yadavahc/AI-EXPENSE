...
export const TESTIMONIALS = [
  {
    quote:
      "AI Expense Splitter made our college trip so easy! No more confusion about who owes what, it handled everything perfectly",
    name: "Pavan Kumar",
    image: "/testimonials/pavan.jpg",
    role: "Student at TOCE",
  },
  {
    quote:
      "I loved how simple it was to split bills with friends. The AI suggestions helped us track every expense without arguments!",
    name: "Likith Lochan",
    image: "/testimonials/likith.jpg",
    role: "Student at APS",
  },
  {
    quote:
      "Managing birthday party expenses used to be chaotic, but this app saved us so much time. It's perfect for students like us!",
    name: "Gopal Kulkarni",
    image: "/testimonials/gopal.jpg",
    role: "Student at TOCE",
  },
];
